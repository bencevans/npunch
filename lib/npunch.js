...
exports.unlink = function (projectNameOrPath) {
	...
	// Find project's name
	var projectName = self.findProjectName(projectNameOrPath);

	// Check there's been a project's name returned
	...
	// Go forth and unlink
	return fs.unlinkSync(self.nodepunchPath + '/' + projectName);
...
exports.exists = function (projectName) {
	if(_.find(nodepunch.list(), function(project){
